...
<!--carousel 1 -->
      <div id="carouselExampleIndicators" class="carousel slide"  data-ride="carousel">
         ...
         <div class="carousel-inner" style="width: 40rem;"> 
            <div class="carousel-item active">
                 <a href="/article1"><img class="d-block w-100" src="/img/Brownies/Brownie.jpg" alt="First slide"></a>
             ...
             <div class="carousel-item">
                 <a href="/article1"><img class="d-block w-100" src="/img/Brownies/brownies1.jpg" alt="Second slide"></a>
                 <div class="carousel-caption d-none d-md-block">
                  <h3><a href="/article1">Best Ever Chocolate Brownies</a></h3>
                  <p>These Gooey Chocolate Brownies have a crisp, sugary top and are deliciously soft, gooey and fudgy inside. Why not get baking with the kids this Easter?</p>                 </div>
             </div>
             <div class="carousel-item">
                 <a href="/article1"><img class="d-block w-100" src="/img/Brownies/brownies3.jpg" alt="Third slide"></a>
                 <div class="carousel-caption d-none d-md-block">
                  <h3><a href="/article1">Best Ever Chocolate Brownies</a></h3>
   ...
   <!--carousel 2 -->
      ...
      <div id="carouselExampleIndicators" class="carousel slide"  data-ride="carousel">
         ...
         <div class="carousel-inner" style="width: 40rem;"> 
            <div class="carousel-item active">
                 <a href="/article2"><img class="d-block w-100" src="/img/Pancakes/pancakes.jpg" alt="First slide"></a>
                 <div class="carousel-caption d-none d-md-block">
             ...
             <div class="carousel-item">
                 <a href="/article2"><img class="d-block w-100" src="/img/Pancakes/pancakes1.jpg" alt="Second slide"></a>
                 <div class="carousel-caption d-none d-md-block">
                  <h3><a href="/article2">Easy Oatmeal Pancakes</a></h3>
                  <p>A simple, homey recipe for pancakes made with old-fashioned rolled oats.</p>                 </div>
             </div>
             <div class="carousel-item">
                 <a href="/article2"><img class="d-block w-100" src="/img/Pancakes/pancakes2.jpg" alt="Third slide"></a>
                 <div class="carousel-caption d-none d-md-block">
                  <h3><a href="/article2">Easy Oatmeal Pancakes</a></h3>
      ...
      <div id="carouselExampleIndicators" class="carousel slide"  data-ride="carousel">
         ...
         <div class="carousel-inner" style="width: 40rem;"> 
            <div class="carousel-item active">
                 <a href="/article3"><img class="d-block w-100" src="/img/Pumpkin/pumpkin.jpg" alt="First slide"></a>
                 <div class="carousel-caption d-none d-md-block">
                  <h3><a href="/article3">Best Ever Pumpkins</a></h3>
                  <p>These Gooey Chocolate Brownies have a crisp, sugary top and are deliciously soft, gooey and fudgy inside. Why not get baking with the kids this Easter?</p>                 </div>
             </div>
             <div class="carousel-item">
                 <a href="/article3"><img class="d-block w-100" src="/img/Pumpkin/pumpkin1.jpg" alt="Second slide"></a>
                 <div class="carousel-caption d-none d-md-block">
                  <h3><a href="/article3">Best Ever Pumpkins</a></h3>
                  <p>These Gooey Chocolate Brownies have a crisp, sugary top and are deliciously soft, gooey and fudgy inside. Why not get baking with the kids this Easter?</p>                 </div>
             </div>
             <div class="carousel-item">
                 <a href="/article3"><img class="d-block w-100" src="/img/Pumpkin/pumpkin2.jpg" alt="Third slide"></a>
                 <div class="carousel-caption d-none d-md-block">
                  <h3><a href="/article3">Best Ever Pumpkins</a></h3>
                  <p>These Gooey Chocolate Brownies have a crisp, sugary top and are deliciously soft, gooey and fudgy inside. Why not get baking with the kids this Easter?</p>
                 </div>
